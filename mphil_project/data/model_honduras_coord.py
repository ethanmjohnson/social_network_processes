def create_honduras_coord_event_log(data, trim_length, log_length):
    """
...
if __name__ == "__main__":
    ...
    log = create_honduras_coord_event_log(data, 30, 100)

    pm4py.write_xes(log, Path(__file__).parent.parent.parent / "data/processed/honduras_coordinated_log.xes")
