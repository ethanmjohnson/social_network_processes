def create_uae_uncoord_event_log(data, trim_length, log_length):
    """
...
if __name__ == "__main__":
    ...
    path = Path(__file__).parent.parent.parent / "data/external/uae-good-anonymized"

    data = pd.read_json(path, lines = True)

    log = create_uae_uncoord_event_log(data, 30, 100)

    pm4py.write_xes(log, Path(__file__).parent.parent.parent / "data/processed/uae_uncoordinated_log.xes")
    ...
    pm4py.write_pnml(net, im, fm, str(Path(__file__).parent.parent.parent / "models/uae_uncoordinated.pnml"))
    ...
    pn_viz.save(gviz, Path(__file__).parent.parent.parent / "figures/uae_uncoordinated.png")