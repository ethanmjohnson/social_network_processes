...
def best_fitting_distribution(time_differences):
    ...
    """
    This function finds the best fitting distribution to a list of time differences. 
    This function tests the exponential, gamma, lognormal, weibull, and normal distributions.

    Input:
    time_differences: the list of time differences

    Output:
    Some lambda function relating to the best fitting distribution
    """
